...
const Login = () => {
  ...
  const handleGoogleLoginClientSide = async (credentialResponse: any) => {
    try {
      setIsLoading(true);
      setError("");
      ...
      <div className="flex h-screen w-screen overflow-hidden bg-white">
        <div className="w-1/2 z-10 flex flex-col justify-center p-12">
          <div className="max-w-[430px] w-full self-center">
            ...
            {/* Opsi 1: Redirect ke server untuk OAuth flow */}
            <button 
            ...
            {/* Opsi 2: Google Login button (client-side) */}
            {/* <div className="mt-4 w-full flex justify-center">
              <GoogleLogin
                onSuccess={handleGoogleLoginClientSide}
        ...
        <div className="relative w-1/2 h-full">
          ...
          <div className="h-full w-full bg-[#E7DECD] flex flex-col items-center justify-center pt-12 px-8">
            <img src="/logo-green.svg" className="w-70" alt="Logo" />
            <div className="py-8">
