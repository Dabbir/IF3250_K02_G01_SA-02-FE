                ...
                <div ref={formRef}>
                    ...
                    <div className="space-y-4 mt-6 border-t pt-4">
                        <div className="flex justify-between items-center">
                            <h3 className="font-semibold">Stakeholder</h3>
                            <Button
                                type="button"
                    ...
                    <div className="space-y-4 mt-6 border-t pt-4">
                        <div className="flex justify-between items-center">
                            <h3 className="font-semibold">Penerima Manfaat</h3>
                            <Button
                                type="button"
                    ...
                    <div className="space-y-4 mt-6 border-t pt-4">
                        <div className="flex justify-between items-center">
                            ...
                            <Button type="button" onClick={addKaryawan} variant="outline" size="sm" className="text-[var(--green)]">
                                + Tambah Karyawan
                            </Button>
                        </div>
